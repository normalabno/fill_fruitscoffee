  ...
  return (
      <div className="flex flex-col items-center justify-center">
        ...
        <section className="flex flex-row items-center gap-x-4  gap-y-4 flex-wrap mt-8 pb-16 mb-8">
            ...
            <Menucard srcimage="/menu_orangecoffee_0.jpg" name="オレンジコーヒー" allergie="乳,大豆,りんご,オレンジ,バナナ" price="330"/>
            ...
            <Menucard srcimage="/menu_fruitscookie.jpg" name="日替わりクッキー" allergie="卵,小麦,乳,大豆,鶏肉,りんご,バナナ,オレンジ,ごま,カシューナッツ,アーモンド,くるみ" price="110"/>        
            <Menucard srcimage="/menu_fruitscurry.jpg" name="フルーツカレー" allergie="小麦,乳,大豆,鶏肉,りんご,バナナ,ゼラチン,ごま,カシューナッツ/アーモンド" price="330"/>
            <Menucard srcimage="/menu_pizza.jpg" name="フルーツピザ" allergie="卵,小麦,乳,大豆,鶏肉,りんご,バナナ,オレンジ,ごま" price="550"/>        
            <Menucard srcimage="/menu_fruitssalada.jpg" name="日替わりサラダ" allergie="卵,小麦,乳,大豆,鶏肉,りんご,バナナ,オレンジ,ごま,カシューナッツ,アーモンド,くるみ" price="110"/>
            
            <Menucard srcimage="/menu_icecream.jpg" name="アイスクリーム" allergie="卵,乳,大豆,鶏肉,りんご,バナナ,オレンジ" price="110"/>
        </section>
    </div>
  );
}
