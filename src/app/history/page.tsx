      ...
      <div className="bg-white flex flex-col items-center gap-y-4">  
         ...
         <section className="mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-16">
               <Image src="/history_1_outofproduce.jpg" width={1280} height={720} alt="規格外オレンジ" className="hidden md:block w-full h-auto rounded-2xl shadow-2xl"/>
               <div>
               ...
               <Image src="/history_1_outofproduce.jpg" width={1280} height={720} alt="規格外オレンジ" className="md:hidden w-full h-auto rounded-2xl shadow-2xl"/>
            </div>
         </section>
         <section className="mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-16">
               ...
               <Image src="/history_2_coffeebeans.jpg" width={1280} height={720} alt="コーヒー豆" className="hidden md:block w-full h-auto rounded-2xl shadow-2xl"/>
               <Image src="/history_2_coffeebeans.jpg" width={1280} height={720} alt="コーヒー豆" className="md:hidden w-full h-auto rounded-2xl shadow-2xl"/>
            </div>
         </section>
         <section className="mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-16">
               <Image src="/filllogo.png" width={1280} height={720} alt="会社ロゴ" className="hidden md:block w-full h-auto rounded-2xl shadow-2xl"/>
               <div>
               ...
               <Image src="/filllogo.png" width={1280} height={720} alt="会社ロゴ" className="md:hidden w-full h-auto rounded-2xl shadow-2xl"/>
            </div>
         </section>
         <section className="mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-16">
               ...
               <Image src="/oragecoffee.jpg" width={1280} height={720} alt="オレンジコーヒー" className="hidden md:block w-full h-auto rounded-2xl shadow-2xl"/>
               <Image src="/oragecoffee.jpg" width={1280} height={720} alt="オレンジコーヒー" className="md:hidden w-full h-auto rounded-2xl shadow-2xl"/>
            </div>
         </section>
         <section className="mx-4 mb-8 pb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-16">
               <Image src="/menu_pizza.jpg" width={1280} height={720} alt="フルーツピザ" className="hidden md:block w-full h-auto rounded-2xl shadow-2xl"/>
               <div>
               ...
               <Image src="/menu_pizza.jpg" width={1280} height={720} alt="フルーツピザ" className="md:hidden w-full h-auto rounded-2xl shadow-2xl"/>
            </div>
         </section>
      </div>
